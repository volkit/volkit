...
#---------------------------------------------------------------------------------------------------
# vkt_use_package(name)
#

function(vkt_use_package name)
    ...
    set(__VKT_USED_PACKAGES ${__VKT_USED_PACKAGES} ${upper_name} PARENT_SCOPE)
    ...
    set(__VKT_LINK_LIBRARIES ${__VKT_LINK_LIBRARIES} ${pkg_LIBS} PARENT_SCOPE)
endfunction()
